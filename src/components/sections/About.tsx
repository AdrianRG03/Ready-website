    ...
    <div className="relative flex items-center justify-center">
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(circle, rgba(200,250,180,0.18) 0%, transparent 70%)',
        }}
      />
      ...
      <svg width="280" height="280" viewBox="0 0 280 280" fill="none" aria-hidden="true">
        ...
        >
          <circle cx="140" cy="140" r="128"
            stroke="rgba(200,250,180,0.22)" strokeWidth="1.5" strokeDasharray="5 7" />
          {ornaments.map((pt, i) => (
            <rect
              key={i}
              x={pt.x - 3.5} y={pt.y - 3.5} width={7} height={7}
              fill="#F0FAB4" opacity={0.6}
        ...
        <circle cx="140" cy="140" r="108"
          stroke="rgba(200,250,180,0.12)" strokeWidth="1" />

        {/* ── Inner filled circle ── */}
        <circle cx="140" cy="140" r="92"
          fill="url(#badgeInner)"
          stroke="rgba(200,250,180,0.35)" strokeWidth="1.5" />

        {/* ── Arc text top: CERTIFICADO · READY · ── */}
        <text fontSize="9.5" letterSpacing="3.5" fill="rgba(200,250,180,0.65)"
        ...
        <g transform="translate(140,140)" filter="url(#glow)">
          ...
          <path
            ...
            fill="rgba(200,250,180,0.10)"
            stroke="#F0FAB4" strokeWidth="1.6"
          />
          {/* Checkmark */}
          <polyline
            points="-10,1 -2,11 13,-10"
            stroke="#F0FAB4" strokeWidth="2.8"
        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          <div>
            ...
            >
              ...
              <span style={{ color: '#1A6B58' }}> {t('selloReady.subtitleHighlight')} </span>
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      color: '#0F5C4A',
                      border: '1px solid rgba(15,92,74,0.15)',
                    }}
                  >
                    {item.icon}
                  </div>
                  ...
                  {/* Texto */}
                  <div>
                    <h3 className="font-bold text-sm mb-1" style={{ color: '#1c2419' }}>
                      {t(item.titleKey)}
                    </h3>
                    <p className="text-xs leading-relaxed" style={{ color: 'rgba(28,36,25,0.55)' }}>
                      {t(item.descKey)}
                    </p>
                  </div>
                  ...
                  <div className="ml-auto shrink-0 mt-1">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                      stroke="rgba(15,92,74,0.5)" strokeWidth={2.5}
                      strokeLinecap="round" strokeLinejoin="round">
            ...
            >
              <a
                ...
                className="btn-shimmer inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-[6px] font-semibold text-sm transition-all duration-200 hover:scale-105 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F0FAB4]"
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-[6px] font-semibold text-sm transition-all duration-200 hover:bg-[#0F5C4A]/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0F5C4A]"
                style={{ border: '1px solid rgba(15,92,74,0.3)', color: '#0F5C4A' }}
              >
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6 w-full max-w-xs">
              {STATS.map((stat, i) => (
                ...
                >
                  ...
                  <div className="text-[10px] leading-tight" style={{ color: 'rgba(28,36,25,0.5)' }}>
                    {t(stat.labelKey)}
                  </div>
                </motion.div>
              ))}
            ...
            {/* Tagline */}
            <p className="text-xs text-center tracking-wide -mt-4" style={{ color: 'rgba(28,36,25,0.35)' }}>
